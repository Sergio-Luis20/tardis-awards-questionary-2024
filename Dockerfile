...
RUN --mount=type=secret,id=simple_questions_base64,dst=/etc/secrets/simple_questions_base64 \
    base64 -d simple_questions_base64 > /src/main/resources/simple-questions.csv
